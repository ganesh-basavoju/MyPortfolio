...
const Projects = () => {
  const projects: Project[] = [
    {
      title: "ChitChat", 
      description: "ChitChat is a real-time chat application designed to facilitate seamless and instant communication between users.",
      liveUrl: "https://chitchat-application-yyjs.onrender.com/",
      githubUrl: "https://github.com/ganesh-basavoju/ChitChat-Application",
      tech: ["React", "Javascript", "Node.js", "Express", "TailwindCSS", "MongoDB"],
      image: "/project-images/chitchat.png",
      repoName: "ChitChat"
    },
    {
      title: "Mess Monitoring",
      description: "Complaint Management System with advanced Statistics Representation features.",
      liveUrl: "https://mess-monetering.vercel.app/", 
      githubUrl: "https://github.com/skjani314/MessMonetering",
      tech: ["React", "MongoDB", "Socket.io", "Node.js"],
      image: "/project-images/mess.png",
      repoName: "MessMonitoring"
    },
    {
      title: "RecipeShare",
      description: "A Recipe-Sharing platform where users can explore, create, and save their favorite recipes",
      liveUrl: "https://recipe-share-frontend-ten.vercel.app/",
      githubUrl: "https://github.com/Lalithkumar-19/RecipeShare-frontend",
      tech: ["React", "Node.js", "MySQL", "Gen-AI", "Google-Auth", "JWT", "AI-Bot"],
      image: "/project-images/recipe.png",
      repoName: "RecipeShare"
    },
    {
      title: "TaskMaster", 
      ...
      githubUrl: "https://github.com/ganesh-basavoju/TaskMaster",
    ...
    {
      title: "PowerGym",
      description: "The Power Gym is a responsive website and interactive UI elements to enhance engagement.",
      liveUrl: "https://ganesh-basavoju.github.io/Power_Gym_website/",
      githubUrl: "https://github.com/ganesh-basavoju/Power_Gym_website",
      tech: ["React", "JavaScript", "Vite", "TailwindCSS"],
      image: "/project-images/powergym.png",
      repoName: "PowerGym"
    },
    {
      title: "TicTacToe", 
      description: "Platform for students to join study groups and collaborate offline.",
      liveUrl: "https://ganesh-basavoju.github.io/Tic-Tac-Toe_App/",
      githubUrl: "https://github.com/ganesh-basavoju/Tic-Tac-Toe_App",
      tech: ["Javascript", "React", "Recoil", "TailwindCSS"],
