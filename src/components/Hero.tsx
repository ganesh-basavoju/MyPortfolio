        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="lg:w-1/2 space-y-6">
              ...
              >
                <span className="text-orange-500">GANESH_BV</span>
              </motion.h1>
              ...
              >
                ...
                DevOps and cloud technologies while pursuing my degree at RGUKT.
              </motion.p>
              ...
              >
                ...
                Shivalayam Road, Jaggayyapet, Andhra Pradesh, India
              </motion.p>
              ...
              >
                <motion.a
                  href="mailto:basavojuganesh@gmail.com"
              ...
              >
                {[
                  { icon: FaGithub, link: "https://github.com/ganesh-basavoju", label: "GitHub" },
                  { icon: FaLinkedin, link: "https://linkedin.com/in/ganesh-basavoju", label: "LinkedIn" },
                  { icon: RiTwitterXFill, link: "https://x.com/Ganesh_basavoju", label: "X (Twitter)" },
                  { icon: FaYoutube, link: "https://www.youtube.com/@ganesh_basavoju", label: "YouTube" },
                ].map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.link}
            ...
            >
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-96 lg:h-96">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full blur-lg opacity-30" />
                <div className="relative rounded-full overflow-hidden border-4 border-orange-500/20 w-full h-full">
                  <img
                    src="/project-images/profile.png"
                    alt="Ganesh BV Profile"
                ...
                <motion.div
                  ...
                  className="absolute -top-8 -right-8 w-32 h-32 border-4 border-orange-200/30 rounded-full"
                />
                <motion.div
                  animate={{ rotate: -360 }}
                  transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
                  className="absolute -bottom-8 -left-8 w-32 h-32 border-4 border-blue-200/30 rounded-full"
                />
              </div>
            </motion.div>
          </div>
