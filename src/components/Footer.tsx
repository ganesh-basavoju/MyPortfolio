...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/ganesh-basavoju",
      icon: SiGithub,
      color: "#333"
    },
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/ganesh-basavoju",
      icon: SiLinkedin,
      color: "#0077B5"
    },
    {
      name: "X",
      url: "https://x.com/Ganesh_basavoju",
      icon: RiTwitterXFill,
      color: "#000000"
    },
    {
      name: "YouTube",
      url: "https://www.youtube.com/@ganesh_basavoju",
      icon: FaYoutube,
      color: "#FF0000"
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <span>by</span>
            <motion.a
              href="https://github.com/ganesh-basavoju"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <span>for</span>
            <motion.a
              href="https://www.linkedin.com/in/ganesh-basavoju"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
