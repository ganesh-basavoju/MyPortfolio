  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      date: "2022 - 2026",
      achievements: [
        <span>Second Prize in the Inter-University TechHackathon (2025).</span>,
        <span>First Prize in codeQuiz 2024.</span>,
          ...
          <a href='#' target='_blank' className='text-decoration-none'>
            <span className="text-sm">
              ...
              state level
                  ...
                  <span className="text-sm font-medium">95% Academic Score</span>
                </div>
      ],
